...
const Navbar = ({ smallScreenOverlap = false }) => {
  ...
  return (
    <>
      {/* Small Screens */}
      <div
        className={`w-screen block bottom-0 z-10 xl:hidden ${
          smallScreenOverlap ? 'absolute' : 'min-h-[3.5rem] static'
        }`}>
        <nav className="w-screen flex flex-row bg-white border-r px-1 static bottom-0 h-fit">
            ...
            {navItems.map((item, index) => {
              ...
              return (
                <a
                  ...
                  className="relative flex justify-center items-center cursor-pointer hover:bg-primary-100 rounded-lg w-full font-medium py-3 my-1"
                >
      ...
      {/* Big Screens */}
      <div className="h-screen hidden xl:static z-10 left-0 top-0 xl:flex xl:flex-col xl:min-w-20 bg-white border-r">
        <nav
          className={`h-screen flex flex-col bg-white border-r px-1 ${
